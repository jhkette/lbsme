      ...
      <div className="my-16  mt-21 ">
        ...
        <div className="w-1/2 p-4  overflow-x-auto scrollbar-nice">
          <div className="flex flex-col items-start justify-start gap-4 mx-8 pb-1 my-2">
            ...
            <p className="text-lg font-semibold text-lbtext">Name: <span className="text-lbtextdark font-normal">{user?.givenName}{" "}{user?.familyName}</span></p>
            <p className="text-lg font-semibold text-lbtext">Subscribed status: <span className="text-lbtextdark font-normal">{subscribed ? "Active" : "Inactive"}</span></p>
            {accountInfoList.map((account, index) => (
              <div key={index} className="flex flex-col gap-7">
                ...
                <p className="text-lg font-semibold text-lbtext">
                  Bank connection status: <span className="text-lbtextdark font-normal">{account.status}</span>
                </p>
                <p className="text-lg font-semibold text-lbtext flex flex-row items-center gap-2 justify-start">
                 Account:   {account.provider.icon ? (
                    <Image
       ...
       <div className="flex flex-col items-center justify-center text-lg font-semibold text-lbtext  bg-lbgray rounded-2xl  mx-18 my-8 p-12"> 
