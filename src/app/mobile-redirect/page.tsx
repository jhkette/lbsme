  ...
  return (
    <div className='w-full'>
      ...
      <h1 className='text-2xl font-bold text-lbgreen mb-4 px-12 text-center w-full'>
       This site is intended to be used on a desktopor laptop. Please download the app from the <Link className='text-lbtext hover:text-lbgreen' href={"#"}>App Store</Link> or <Link className='text-lbtext hover:text-lbgreen' href={"#"}>
      Google Play Store </Link> to continue.
      </h1>
