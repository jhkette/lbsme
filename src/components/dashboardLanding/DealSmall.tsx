...
export default function SmallDealItem(props: SmallDealItem) {
  return (
   ...
   <div className="bg-[url(/images/deals/dealbg.png)] w-full max-w-[250px] h-[150px] md:h-[155px] lg:h-[160px] bg-center bg-no-repeat bg-cover rounded-lg my-4 py-6 md:py-8 hover:opacity-75">
