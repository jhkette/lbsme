...
export default function SidebarItem({ iconName, label }: SidebarItemProps) {
  ...
  return (
    ...
    <li
      className="p-6 flex flex-col items-center justify-center text-white text-lg cursor w-full border-1 border-r-1 border-lbgreen hover:bg-white hover:text-lbgreen duration-300 ease-in-out"
