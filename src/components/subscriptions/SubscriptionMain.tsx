					...
					{["All Subscriptions", ...Object.keys(groupedSubs)].map(
						(category) => (
							<li
								...
								className={clsx(
									"block z-200 text-lbgrey text-lg list-none pb-1 mb-2 ease-in-out cursor-pointer",
									selectedCategory === category
										? "border-b-2 border-lbtext text-lbtext font-semibold "
										: "hover:text-lbtext",
								)}
							>
								{category}
					...
					<table className="min-w-full bg-white  border-1 border-lbgray h-fit">
						<thead className="text-base lg:text-lg font-semibold text-lbtext  ">
							<tr className="bg-bggrey">
								<th className="py-4 px-4 max-w-[320px] text-wrap text-left">
									Name
								</th>
								...
								return (
									...
									>
										...
										<td className="py-2 px-4">
											<p className="w-fit bg-lbbgblue text-white px-3 py-1 rounded-lg text-xs">
