...
export default function BirdLead() {
  return (
    <div className="flex flex-col  items-center justify-center h-screen w-1/2 pt-16 
    bg-lbblue 
    ">
          ...
          <div className="text-center">
           ...
           <h1 className="text-4xl/12 font-bold text-lbtext mb-4 px-12  text-center w-[85%] ">
            ...
            <h2 className="text-xl/8 font-bold text-lbtext opacity-90 mb-4 px-12  text-center w-[70%]"> 
