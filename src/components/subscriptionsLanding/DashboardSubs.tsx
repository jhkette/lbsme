...
export default function DashboardSubs() {
  ...
  return (
    <div className='flex flex-row justify-center shadow-lg bg-white rounded-lg p-4 w-full h-36'>
        <div className='flex flex-col justify-center items-center w-1/5'>
            <p className='text-4xl py-2'>{subscriptions}</p>
            <p className='text-lg font-base'>Subscriptions</p>
        </div>
        <div className='flex flex-col justify-center items-center w-1/5'>
        <p className='text-4xl py-2'>{monthlySpending}</p>
            <p className='text-lg font-base'>Monthly Spend</p>
        </div>
         <div className='flex flex-col justify-center items-center w-1/5'>
        <p className='text-4xl py-2'>{yearlSpending}</p>
            <p className='text-lg font-base'>Yearly subcsriptions</p>
        </div>
        <div className='flex flex-col justify-center items-center w-1/5'>
        <p className='text-4xl py-2'>{expectedMonthlySavings}</p>
            <p className='text-lg font-base'>Expected Monthly Saving</p>
        </div>
         <div className='flex flex-col justify-center items-center w-1/5'>
        <p className='text-4xl py-2'>{expectedYearlySavings}</p>
