...
export default function DashboardSubs(subs: DashboardSubsProps) {
  ...
  const subscriptions: number = 12; // Placeholder for total subscriptions, can be replaced with actual data
  const monthlySpending: number = 250; // Placeholder for monthly spending, can be replaced with actual data
  const yearlSpending: number = 3000; // Placeholder for yearly spending, can be replaced with actual data
  const expectedMonthlySavings: number = 50; // Placeholder for expected monthly savings, can be replaced with actual data
  const expectedYearlySavings: number = 600; // Placeholder for expected yearly savings, can be replaced with actual data
  return (
