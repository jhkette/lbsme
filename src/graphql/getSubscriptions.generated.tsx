...
export type GetBankAccountDaysLeftQueryVariables = Types.Exact<{
	[key: string]: never;
}>;

export type GetBankAccountDaysLeftQuery = {
	__typename?: "Query";
	getBankAccount: Array<{
		__typename?: "BankAccountResultType";
		status: Types.BankAccountStatusEnum;
		linkDetails: { __typename?: "BankAccountLinkDetails"; daysLeft: number };
	}>;
};
 ...
 * });
 */
export function useGetBankAccountDaysLeftQuery(
	baseOptions?: Apollo.QueryHookOptions<
		GetBankAccountDaysLeftQuery,
		GetBankAccountDaysLeftQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<
		GetBankAccountDaysLeftQuery,
		GetBankAccountDaysLeftQueryVariables
	>(GetBankAccountDaysLeftDocument, options);
}
export function useGetBankAccountDaysLeftLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		GetBankAccountDaysLeftQuery,
		GetBankAccountDaysLeftQueryVariables
	>,
...
export function useGetBankAccountDaysLeftSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
		| Apollo.SuspenseQueryHookOptions<
				GetBankAccountDaysLeftQuery,
...
export type GetBankAccountDaysLeftQueryHookResult = ReturnType<
	typeof useGetBankAccountDaysLeftQuery
>;
export type GetBankAccountDaysLeftLazyQueryHookResult = ReturnType<
	typeof useGetBankAccountDaysLeftLazyQuery
>;
export type GetBankAccountDaysLeftSuspenseQueryHookResult = ReturnType<
	typeof useGetBankAccountDaysLeftSuspenseQuery
>;
export type GetBankAccountDaysLeftQueryResult = Apollo.QueryResult<
	GetBankAccountDaysLeftQuery,
	GetBankAccountDaysLeftQueryVariables
>;
