...
export function useGetProvidersQuery(
	...
	> &
		(
			| { variables: GetProvidersQueryVariables; skip?: boolean }
			| { skip: boolean }
		),
) {
...
export function useGetProvidersSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		...
		GetProvidersQueryVariables
	>,
): Apollo.UseSuspenseQueryResult<GetProvidersQuery, GetProvidersQueryVariables>;
export function useGetProvidersSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
