...
export type GetSubscriptionQuery = { __typename?: 'Query', getSubscription: { __typename?: 'SubscriptionDetails', freeTrial: boolean, isManual: boolean, status: Types.SubscriptionStatusEnum, displayName?: string | null, paymentMethod?: string | null, subscriptionId: string, cancellationStatus?: Types.CancellationStatusEnum | null, type: Types.SubscriptionPriceTypeEnum, category: { __typename?: 'AssignedCategory', category: string, PK: string, searchCategory: string, searchSubCategory: string, SK: string, subCategory: string }, costs: { __typename?: 'SubscriptionCosts', amount: number, monthly: number, priceChange: number, totalRemaining?: number | null, average_monthly?: number | null, totalSpent: number, yearly: number, saveUp: number }, dates: { __typename?: 'SubscriptionDates', endsInDays: number, endsInPercent?: number | null, lastPaymentDate: string, renewalDate: string, contractEndDate?: string | null }, merchant: { __typename?: 'Merchant', icon?: string | null, id: string, name: string }, transactions?: Array<{ __typename?: 'TransactionData', accountID?: string | null, bookingTime?: string | null, budId?: string | null, title?: string | null, transactionId?: string | null, amount?: { __typename?: 'TransactionAmount', amount?: number | null, currency?: string | null } | null, provider?: { __typename?: 'ProviderData', id?: string | null, name?: string | null } | null } | null> | null } };
