...
// @ts-ignore
export function useGetSubscriptionSpendingsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetSubscriptionSpendingsQuery, GetSubscriptionSpendingsQueryVariables>): Apollo.UseSuspenseQueryResult<GetSubscriptionSpendingsQuery, GetSubscriptionSpendingsQueryVariables>;
export function useGetSubscriptionSpendingsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSubscriptionSpendingsQuery, GetSubscriptionSpendingsQueryVariables>): Apollo.UseSuspenseQueryResult<GetSubscriptionSpendingsQuery | undefined, GetSubscriptionSpendingsQueryVariables>;
...
// @ts-ignore
export function useGetUserCategoriesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUserCategoriesQuery, GetUserCategoriesQueryVariables>): Apollo.UseSuspenseQueryResult<GetUserCategoriesQuery, GetUserCategoriesQueryVariables>;
export function useGetUserCategoriesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetUserCategoriesQuery, GetUserCategoriesQueryVariables>): Apollo.UseSuspenseQueryResult<GetUserCategoriesQuery | undefined, GetUserCategoriesQueryVariables>;
...
// @ts-ignore
export function useGetUpcomingRenewalsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUpcomingRenewalsQuery, GetUpcomingRenewalsQueryVariables>): Apollo.UseSuspenseQueryResult<GetUpcomingRenewalsQuery, GetUpcomingRenewalsQueryVariables>;
export function useGetUpcomingRenewalsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetUpcomingRenewalsQuery, GetUpcomingRenewalsQueryVariables>): Apollo.UseSuspenseQueryResult<GetUpcomingRenewalsQuery | undefined, GetUpcomingRenewalsQueryVariables>;
