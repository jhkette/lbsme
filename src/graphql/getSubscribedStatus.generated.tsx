...
// @ts-ignore
export function useStatusSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<StatusQuery, StatusQueryVariables>): Apollo.UseSuspenseQueryResult<StatusQuery, StatusQueryVariables>;
export function useStatusSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<StatusQuery, StatusQueryVariables>): Apollo.UseSuspenseQueryResult<StatusQuery | undefined, StatusQueryVariables>;
