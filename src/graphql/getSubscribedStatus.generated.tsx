...
// @ts-ignore
export function useStatusSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		StatusQuery,
		StatusQueryVariables
	>,
): Apollo.UseSuspenseQueryResult<StatusQuery, StatusQueryVariables>;
export function useStatusSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
		| Apollo.SuspenseQueryHookOptions<StatusQuery, StatusQueryVariables>,
): Apollo.UseSuspenseQueryResult<StatusQuery | undefined, StatusQueryVariables>;
export function useStatusSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
		| Apollo.SuspenseQueryHookOptions<StatusQuery, StatusQueryVariables>,
	...
	return Apollo.useSuspenseQuery<StatusQuery, StatusQueryVariables>(
		StatusDocument,
		options,
	);
}
...
export type StatusSuspenseQueryHookResult = ReturnType<
	typeof useStatusSuspenseQuery
>;
